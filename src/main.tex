...
\begin{document}
    ...
    \section{おわりに}
    本稿では，視覚運動に同期して前庭電気刺激と頬・首振動を同時制御する加速度感覚誘発システムを提案し，6条件の被験者内比較によりVRSQとVASを用いて評価した．その結果，無刺激条件に対してGVS弱または振動刺激の付与でVR酔い改善に有意差が確認された．今後は，個人適応を導入し，刺激設計の最適化を進め，幅広いコンテンツや運動条件においても安定して効果を発揮する汎用的な感覚提示手法の確立を目指す．
